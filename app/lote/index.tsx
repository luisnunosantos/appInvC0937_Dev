  ...
  if (!permission.granted) {
    return (
      <View style={styles.permissionContainer}>
        ...
        <KeyButton title="Permitir Câmara" onPress={requestPermission} />
      </View>
    );
  }
        ...
        {scannedItems.length > 0 && !loading && (
          <View
            style={[
              ...
              { opacity: modalVisible ? 0 : 1 }, // Esconde visualmente
            ]}
            pointerEvents={modalVisible ? "none" : "auto"} // Impede cliques quando invisível
          >
            <KeyButton
              title={`Finalizar Lote (${scannedItems.length})`}
          ...
          >
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalButtons}>
                {/* Botão SAÍDA usando KeyButton type="danger" (Vermelho) */}
                <View style={{ flex: 1 }}>
                  <KeyButton
                    title="Saída"
                    type="danger"
                ...
                {/* Botão ENTRADA usando KeyButton type="primary" (Amarelo) */}
                <View style={{ flex: 1 }}>
                  <KeyButton
                    title="Entrada"
                    type="primary"
